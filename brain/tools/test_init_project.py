...
class InitProjectTests(unittest.TestCase):
    ...
    def test_creates_minimal_workspace_and_project_record(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertTrue((root / "projects/monthly-report/goal.md").is_file())
            self.assertTrue((root / "projects/monthly-report/03_context/context.md").is_file())
            self.assertTrue((root / "projects/monthly-report/07_logs/decisions.md").is_file())
